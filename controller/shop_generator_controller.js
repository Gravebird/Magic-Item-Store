...
let shopGeneratorController = {
    generate: async function(req, res) {
        ...
        let book_list = '';
        if (typeof sourceBooks == "string") {
            book_list = '"' + sourceBooks + '"';
        } else {
        ...
        while (numItems > 0) {
            ...
            if (infinite_loop_detection > 100) {
                console.log("Infinite loop detected. Ending the shop generation.");
                break;
            }
            ...
            if (rng < weaponPercentage) {
                ...
                if (item != undefined) {
                    ...
                    if (item.Weapon_Material != null) {
                        item_short_description += "{" + item.Weapon_Material.Material_Name + "} ";
            ...
            if (infinite_loop_detection == 0) {
                // If this variable is 0, it means we generated an item this loop
                numItems -= 1;
                item_number += 1;
            }
