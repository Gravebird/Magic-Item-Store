...
<p>* New monster described in Chapter 6 of <em>Sandstorm</em></p>",
    ...
    (712,4,"Vitrify","Transmutation",null,"Earth","V, S, M/DF",
    "1 standard action","Medium","Up to one 10-ft. cube/5 levels (S)",null,"Permanent",
    "See text","No",
    "Melts sand into glass.",
    "<p>This spell transforms normal sand of any depth into crude glass. The sand is instantly heated to the melting point and then slowly hardens in its new form. Objects on or in the sand sink into the hot glass. A creature is allowed a Reflex save to escape before the area is changed. A creature that fails its save and that is unable to levitate, fly, or otherwise free itself sinks partway into the molten glass, reducing its speed to 5 feet and giving it a -2 penalty on attack rolls and to AC. Creatures of the earth subtype can move only 10 feet per round slower in molten glas. If a creature is only partially in the area (such as a Large or larger creature on the edge of the effect), it still takes full damage, but its speed is reduced only by half (instead of to 5 feet).</p><p>A creature caught in molten glass takes 10d6 points of fire damage on the first round. The transmuted material cools over a period of 10 rounds. Each round, the number of dice of damage the cooling glass deals is reduced by one, until it deals no damage. The glass is solid enough to trap creatures by the sixth round.</p><p>Creatures unable to escape the flass before it hardens become trapped and must be broken out. A creature so caught can break free by making a Strength check to break the glass or by dealing damage to the glass. Glass has hardness 1, 1 hit point per inch of thickness, and break DC of 12, +1 per inch of thickness. A creature partially caught in the glass takes a -2 penalty on attack rolls, a -4 penalty to Dexterity, and is unable to move. When breaking glass, a creature takes 1d6 points of damage each time it makes a successful Strength check to break free. If broken free by others, the creature takes 1d6 points of damage from broken glass. A creatuer trapped beneath the surface of the glass might begin to suffocate (see page 304 of the <em>Dungeon Master's Guide</em>).</p>",
    "Arcane Material Component: A small glass marble.",
    null,null),
    
    (713,4,"Wall of Magma","Conjuration","Creation","Earth, Fire","V, S, M/DF",
    "1 standard action","Medium","Wall of molten stone whose area is up to one 5-ft. square/level (S)",null,"1 min./level",
    "See text","Yes",
    "Deals 2d6 fire damage out to 10 ft. and 1d6 out to 20 ft. Passing through wall deals 5d6 damage +1/level.",
    "<p>This spell creates a wall of thick magma that glows with a dull red heat. It merges into adjoining rock surfaces, melting the rock at the point of connection to form a smooth bond. The wall can seal off a passage or breach, but the intense heat causes flammable materials in contact with the <em>wall of magma</em> to catch fire instantly. A <em>wall of magma</em> is 1 inch thick per four caster levels. You can double the wall's area by halving its thickness. The wall cannot be conjured so that it occupies the same space as a creature or another object.</p><p>You can shape a <em>wall of magma</em> into sheets and curves, but the molten wall cannot form domes or unsupported horizontal surfaces more than 5 feet across. The wall need not be vertical but must rest upon a firm foundation; it must merge with and be solidly supported by existing stone. The wall cannot hold complex forms such as crenellations. It is possible (though difficult) to form the wall into a ring to enclose creatures, but they can avoid this with successful Reflex saves.</p><p>The wall sends forth waves of heat, dealing 2d6 points of fire damage to creatures within 20 feet and 1d6 points of fire damage to those past 10 feet but within 20 feet. Unlike a <em>wall of fire</em>, both sides of a <em>wall of magma</em> radiate heat. Since it is molten, the wall cannot be broken as such, but an object or creature could force its way through. It costs 4 squares of movement to move through a square containing a <em>wall of magma</em>, but creatures of the earth subtype can pass through the wall at normal speed. A <em>wall of magma</em> deals 5d6 points of fire damage +1 point of fire damage per caster level (maximum +20) to creatures passing through it, the same amount each round to any creature within it, and 2d6 points of fire damage per round for 1d3 rounds after a creature leaves the area of the wall. It deals double damage to undead and creatures with the water subtype. The wall can be destroyed normally by a <em>disintegrate</em> spell. If any 5-foot section of the wall takes 40 points of cold damage or more in a round, that section hardens into normal stone (hardness 8, 15 hit points per inch of thickness), which can then be chipped or broken as normal (DC 20 Strength check, +2 per inch of thickness). Do not divide cold damage by four, as normal for objects. Casting <em>create water</em> on the surface of a <em>wall of magma</em> creates a cloud of steamy fog that fills a cube with the dimensions of the length of wall affects. The fog dissipates after 10 minutes. Only the surface of the stone hardens; the wall is not cooled completely.</p><p><em>Wall of magma</em> can be made permanent with a <em>permanency</em> spell. A permanent <em>wall of magma</em> that is chilled by cold damage stays solid for 10 minutes, then returns to its molten state.</p>",
    "Arcane Material Component: A small piece of pumice, obsidian, or other volcanic rock.",
    null,null),
    
    (714,4,"Wall of Salt","Conjuration","Creation","Earth","V, S, M/DF",
    "1 standard action","Medium","Salt wall whose area is up to one 5-ft. square/level (S)",null,"Instantaneous",
    "See text","No",
    "Wall of salt that can be shaped.",
    "<p>This spell creates a gleaming wall of salt crystal that merges into adjoining rock surfaces. The wall can seal off a passage or breach, or be used to construct new walls. A <em>wall of salt</em> is 1 inch thick per caster level. You can double the wall's area by halving its thickness. The wall cannot be conjured so that it occupies the same space as a creature or another object.</p><p>You can form a <em>wall of salt</em> into nearly any shape desired. The wall need not be vertical, nor rest upon any firm foundation; however, it must merge with and be solidly supported by existing stone. It can be used to bridge a chasm or as a ramp. If such a span is more than 20 feet long, the wall must be arched and buttressed, reducing the spell's area by half. For example, a 10th-level caster could create a salt span with a surface area of five 5-foot squares. The wall can be crudely shaped to allow crenellations, battlements, and so forth, by likewise reducing the area.</p><p>The wall can be destroyed normally by a <em>disintegrate</em> spell or by chipping and breaking. Each 5-foot square of the wall has 3 hit points per inch and hardness 2. A section of wall whose hit points drop to 0 is breached. If a creature tries to break through the wall with a single attack, the DC for the Strength check is 15 +1 per inch of thickness. Directing a constant blast of water at a <em>wall of salt</em> (for example, a geyser from a <em>decanter of endless water</em>) dissolves the mineral, dealing 10 points of damage per minute (which hardness does not reduce).</p><p>It is possible, but difficult, to trap mobile opponents within or under a <em>wall of salt</em>, provided the wall is shaped so it can hold the creatures. Creatures can avoid entrapment with successful Reflex saves.</p>",
    "Arcane Material Component: A crystal of rock salt.",
    null,null),
    
    (715,4,"Wall of Sand","Conjuration","Creation","Earth","V, S, M/DF",
    "1 standard action","Close","Sand wall whose area is up to one 10-ft. square/level (S)",null,"1 min./level (D)",
    "See text","No",
    "Wall impedes movement, obscures vision, and blocks some attacks.",
    "<p>You cause a flat, vertical wall of churning sand to spring up. The wall is 1 inch thick per caster level and covers up to a 10-foot square area per caster level. You can double the wall's area by halving its thickness. The wall cannot be conjured so that it occupied the same space as a creature or another object.</p><p>No form of physical attack can harm a <em>wall of sand</em> directly, but each 10-foot section has 2 hit points per inch of thickness for determining whether an attack passes through it. The wall reduces damage dealt by attacks that pass through it. It essentially absorbs damage, so attacks must deal more damage than the wall has hit points to have any effect on a target on the other side of the <em>wall of sand</em>. Breaches in the wall close immediately after the attack that made them pass through. The sand blocks line of effect for any fire spell. Creatures on the opposite side of the wall from an attack's origin have total concealment against that attack.</p><p>Moving through a <em>wall of sand</em> requires a Strength check (DC 10 + 1 per inch of thickness). Those who fail must stop in the space from which they attempted to enter the wall. Any creature that attemps to pass through a <em>wall of sand</em> must also make a Fortitude save or be blinded for 1d4+1 rounds. (Creatures without eyes are not subject to this effect.) A creature passing through the roiling wall does not leave a usable breach for others. All nonmagical flames are extinguishes if carried through a <em>wall of sand</em>.</p><p>The spells <em>control sand</em> and <em>move earth</em> can breach and hold open a break in a <em>wall of sand</em>.</p><p>It is possible, but difficult, to trap mobile opponents within a <em>wall of sand</em>, provided the wall is shaped so it can hold the creatures. Creatures can avoid entrapment with successful Reflex saves.</p><p>A <em>wall of sand</em> is treated like normal sand for the duration of the spell, so it can be affected by any spell or effect that affects sand, such as <em>transmute sand to stone</em> or <em>transmute sand to glass</em>. The wall still lasts only for its normal duration, even if its consistency changes.</p><p>A <em>wall of sand</em> can be made permanent with a <em>permanency</em> spell.</p>",
    "Arcane Material Component: A handful of sand.",
    null,null),
    
    (716,4,"Wall of Water","Conjuration","Creation","Water","V, S, M/DF",
    "1 standard action","Close","Wall of water 1 ft. thick whose area is up to one 10-ft. square/level (S)",null,"1 round/level (D)",
    "None","No",
    "Wall impedes movement and can drown creatures.",
    "<p>You cause a vertical wall of swirling water to appear. You can double the area of the wall's effect by halving its thickness.</p><p>Any creature attempting to pass through a square occupied by a <em>wall of water</em> must make a Swim check (DC 14 + your spellcasting ability modifier) or become trapped in the water, unable to move. A creature trapped in this fashion can attempt another Swim check each round and might drown (see Drowning, page 304 of the <em>Dungeon Master's Guide</em>). If you conjure the wall so that it appears where creatures are, each creature must make a Swim check or become trapped; those that succeed can choose on which side they wish to emerge from the water. Any nonmagical flame is extinguishes if carried through a <em>wall of water</em>.</p><p>Few forms of physical attack can harm a <em>wall of water</em> directly. Thrown weapons are ineffective through it, and attacks with other ranged weapons are made with a -2 penalty for every 5 feet of wall through which they must pass (in addition to normal range penalties; minimum penalty -2). A breach in the wall closes immediately after the attack that made it goes through. The water blocks line of effet for any fire spell. Creatures on one side of the wall have cover against those on the other side unless the creature making the attack is under the effect of <em>freedom of movement</em>.</p><p>If any 5-foot section of water takes 20 or more points of fire damage in a single round, that section evaporates into steamy fog that lasts for 1 minute. If any 5-foot section of wall takes 20 or more points of cold damage in 1 round, that length freezes for 10 minutes. Treat a frozen section as a <em>wall of ice</em> instead. In either instance, do not divide damage by four, as is normal for objects.</p><p><em>Control water</em> can open and hold open a breach in a <em>wall of water</em>, so long as that spell can affect enough of the wall.</p><p>A <em>wall of water</em> can be made permanent with a <em>permanency</em> spell.</p>",
    "Arcane Material Component: A vial of water",
    null,null),
    
    (717,4,"Waste Strider","Transmutation",null,null,"V, S, DF",
    "1 standard action","Touch",null,"One touched creature/level","1 hour/level (D)",
    "Will negates (harmless)","Yes (harmless)",
    "Move through the wasteland without penalties.",
    "<p>The subject can move through desert environments without hindrance, ignoring movement penalties and penalties on skill checks for all types of desert and waste terrain. This spell does not grant a subject immunity to other ill effects of waste environments, such as heat and sun.</p>",
    null,null,null),
    
    (718,4,"Whispering Sand","Transmutation",null,"Language-Dependent","V, S, F",
    "1 standard action","See text",null,"One creature/level","10 min./level (D)",
    "None","No",
    "Sand delivers your message.",
    "<p>Sand, ash, or dust serves as a conduit for your conversation with other creatures in far-removed locales. You fix in your mind the identity of the creatures with whom you wish to communicate (you must know, have met, or know the name of the targets), and then speak. You know immediately which of the targets can respond, if any - if the targets possess the appropriate sandy focus (see below), or if the targets are located in areas of sand, dust, or ash, the spell functions; if not, it immediately ends. Barriers and distance are not a factor, as long as both you and the targets have the appropriate focus and are on the same plane. If contact is achieved, the sand whispers your messages back and forth for the duration of the spell, no matter your distance from each other, gleaning a message from a sound akin to wind on sand. The spell does not transcend language barriers.</p>",
    null,"Focus: At least 1 pound of sand, dust, or ash.",null),
    
    (719,4,"Wither","Necromancy",null,null,"V, S, M",
    "1 standard action","Medium",null,"One living creature","Instantaneous",
    "Fortitude partial","Yes",
    "Deals 1d6/level dessication damage and dehydrates living creature.",
    "<p>This spell drains moisture from the body of a living creature. The target takes 1d6 points of dessication damage per caster level (maximum 10d6) and is dehydrated (see page 15). A creature that makes a successful Fortitude save takes half damage and is not dehydrated. A plant or elemental of the water subtype instead takes 1d8 points of dessication damage per caster level (maximum 15d8).</p>",
